...
return [
    'definitions' => [
        ...
        'navigation' => [
            ...
            'fields' => [
                ...
                [
                    ...
                    'description' => 'Marque para mostrar referências na admin (para desenvolvedores).',
                    'default' => false,
                    'active' => 'Mostrar',
                    'inactive' => 'Esconder',
                ],
        ...
        'editor' => [
            'tab' => 'Editor',
            'title' => 'Editor de Conteúdo (Tiptap)',
            ...
            'fields' => [
                [
                    'key' => 'toolbar_tools',
                    'type' => 'checkbox',
                    'label' => 'Elementos Ativos na Barra',
                    'description' => 'Desmarque para ocultar itens específicos da barra de ferramentas.',
                    'default' => [
                        'heading',
                        'bold',
                        'italic',
                    ...
                    'options' => [
                        'heading'       => 'Seletor de Texto / Títulos (H1, H2, H3)',
                        'bold'          => 'Negrito (B)',
                        'italic'        => 'Itálico (I)',
                        'strike'        => 'Tachado (S)',
                        'underline'     => 'Sublinhado (U)',
                        'text_color'    => 'Cor da Fonte (A)',
                        'highlight'     => 'Cor de Fundo / Marca-texto',
                        'link'          => 'Inserir / Editar Link',
                        'bullet_list'   => 'Lista com Marcadores',
                        'ordered_list'  => 'Lista Numerada',
                        'blockquote'    => 'Citação (Blockquote)',
                        'hr'            => 'Linha Divisória (HR)',
                        'indent'        => 'Recuo / Indentação',
                        'table'         => 'Tabelas',
                        'blocks'        => 'Menu Inserir Bloco (+ Bloco)',
                        'media_upload'  => 'Botão Direto de Upload de Imagem',
                        'media_library' => 'Botão Direto da Biblioteca de Mídia',
                        'history'       => 'Desfazer / Refazer (Undo / Redo)',
                    ],
                ],
                [
                    'type' => 'subtitle',
                    'icon' => 'palette',
                    'label' => 'Paleta do Seletor de Cores',
                ],
                [
                    'type' => 'paragraph',
                    'text' => 'Configure as cores pré-definidas da identidade visual exibidas no seletor de cores.',
                ],
                [
                    'key' => 'color_palette',
                    'type' => 'textarea',
                    'label' => 'Cores Pré-definidas (Hexadecimal)',
                    'description' => 'Insira os códigos hexadecimais das cores da sua marca separados por vírgula.',
                    'default' => '#0f172a, #64748b, #ef4444, #f97316, #eab308, #fffd80, #22c55e, #3b82f6, #a855f7, #ec4899',
                ],
                [
                    'key' => 'allow_custom_color',
                    'type' => 'switch',
                    'label' => 'Permitir cor personalizada livre',
                    'description' => 'Exibe o seletor de cor livre além das cores pré-definidas da paleta.',
                    'default' => true,
                    'active' => 'Permitir',
                    'inactive' => 'Apenas pré-definidas',
                ],
            ],
        ],
