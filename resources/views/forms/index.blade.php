...
<div class="admin-card">
    <div class="admin-card-header">
        <h2><x-lucide-file-text class="lucid-icon" /> Lista de Formulários</h2>
    ...
    <div class="table-wrap">
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="admin-actions">
                        <div>
                            ...
                            <a href="{{ route('admin.forms.edit', $form->id) }}" class="admin-btn admin-btn-secondary" style="padding: 4px 12px;" title="Editar">
                                <x-lucide-pencil class="lucid-icon" />
                            </a>
                            <form method="POST" action="{{ route('admin.forms.destroy', $form->id) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="admin-btn admin-btn-danger" style="padding: 4px 12px;" onclick="return confirm('Remover este formulário e todas as suas respostas?')" title="Excluir">
                ...
                @empty
                <tr>
                    <td colspan="7" class="admin-text-center admin-text-muted">Nenhum formulário cadastrado</td>
                </tr>
                @endforelse
            </tbody>
        </table>
