...
<div class="admin-card">
    ...
    <form method="POST" action="{{ route('admin.plugins.marketplace.remove-inactive') }}" style="display: none;" data-confirm="ATENÇÃO: Todos os plugins inativos serão excluídos permanentemente do disco. Deseja continuar?" id="remove_inactive">
        @csrf
        @method('DELETE')
    </form>
