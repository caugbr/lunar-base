    ...
    <form method="POST" action="{{ route('admin.pages.update', $page->id) }}" id="edit_form">
        ...
        <div class="admin-form-row thumb-row">
            ...
            <div class="form-group thumbnail">
                ...
                <div x-data="{
                        thumbnailId: {{ old('thumbnail_id', $page->thumbnail_id) ?: 'null' }},
                        thumbnailUrl: '{{ old('thumbnail_url', $page->thumbnail?->url) ?: '' }}',
                        galleryIds: {{ json_encode(old('gallery_ids', $page->images->pluck('id')->toArray() ?? [])) }},
