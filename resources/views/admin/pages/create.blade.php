    ...
    <form method="POST" action="{{ route('admin.pages.store') }}" id="create_form">
        ...
        <div class="edit-page-inner">
            <div class="main-column">
                ...
                <x-hook name="admin.create_page_main_boxes" desc="Dentro da coluna principal na criação de página" />
            </div>
            ...
            <div class="aside-column">
                ...
                <div class="edit-box">
                    ...
                    <article>
                        ...
                        <div class="form-group">
                            ...
                            <x-page-picker name="parent_id" id="parent_id" :selected="old('parent_id', $page->parent_id ?? '')" placeholder="-- Nenhuma --" />
                ...
                <x-hook name="admin.create_page_side_boxes" desc="Dentro da coluna lateral na criação de página" />
            </div>
        </div>
