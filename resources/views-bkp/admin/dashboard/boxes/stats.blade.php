    ...
    <div class="stats-grid">
        ...
        <div class="stat-card stat-pages">
            ...
            <div class="stat-content">
                ...
                <span class="stat-label">{{ __('Páginas') }}</span>
            </div>
        </div>
        ...
        <div class="stat-card stat-plugins">
            ...
            <div class="stat-content">
                ...
                <span class="stat-label">{{ __('Plugins Ativos') }}</span>
            </div>
        </div>
    </div>
        ...
        <div class="stat-card stat-theme">
            ...
            <div class="stat-content">
                <span class="stat-label">{{ __('Tema Ativo') }}</span>
                <span class="stat-value stat-value-text">{{ $activeTheme ?? __('Nenhum') }}</span>
            </div>
        </div>
