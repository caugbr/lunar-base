...
### Added
- "hideMenuItems" para esconder itens do menu admin por role em config/admin.php
...
## Added
- Toolbar do editor totalmente configurável via Settings
...
### Fixed
- editor-common.js faltando no componente x-editor
